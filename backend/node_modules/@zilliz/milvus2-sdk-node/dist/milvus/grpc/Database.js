...
class Database extends BaseClient_1.BaseClient {
    ...
    createDatabase(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const promise = yield (0, __1.promisify)(this.channelPool, 'CreateDatabase', {
     ...
     * ```
     */
    describeDatabase(data) {
        return __awaiter(this, void 0, void 0, function* () {
            // check compatibility
            yield this.checkCompatibility({
                message: `describeDatabase is not supported on this version of milvus.`,
            });
            const promise = yield (0, __1.promisify)(this.channelPool, 'DescribeDatabase', data, data.timeout || this.timeout);
            return promise;
        });
    }
    /**
