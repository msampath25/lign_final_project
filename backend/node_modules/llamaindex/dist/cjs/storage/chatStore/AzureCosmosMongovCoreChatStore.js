...
Object.defineProperty(exports, "AzureCosmosVCoreChatStore", {
    enumerable: true,
    get: function() {
        return AzureCosmosVCoreChatStore;
    }
});
const _chatstore = require("@llamaindex/core/storage/chat-store");
const DEFAULT_CHAT_DATABASE = "ChatStoreDB";
const DEFAULT_CHAT_Collection = "ChatStoreCollection";
class AzureCosmosVCoreChatStore extends _chatstore.BaseChatStore {
    mongoClient;
    dbName;
    collectionName;
    collection;
