 ...
 */
declare const listKeysApiV1ApiKeysGet: <ThrowOnError extends boolean = false>(options?: Options<ListKeysApiV1ApiKeysGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListKeysApiV1ApiKeysGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Delete Api Key
 ...
 */
declare const listDataSinksApiV1DataSinksGet: <ThrowOnError extends boolean = false>(options?: Options<ListDataSinksApiV1DataSinksGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListDataSinksApiV1DataSinksGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Create Data Sink
 * Create a new data sink.
 */
declare const createDataSinkApiV1DataSinksPost: <ThrowOnError extends boolean = false>(options: Options<CreateDataSinkApiV1DataSinksPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<DataSink, HTTPValidationError, ThrowOnError>;
/**
 * Upsert Data Sink
 * Upserts a data sink.
 * Updates if a data sink with the same name and project_id already exists. Otherwise, creates a new data sink.
 */
declare const upsertDataSinkApiV1DataSinksPut: <ThrowOnError extends boolean = false>(options: Options<UpsertDataSinkApiV1DataSinksPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<DataSink, HTTPValidationError, ThrowOnError>;
/**
 * Get Data Sink
 * Get a data sink by ID.
 */
declare const getDataSinkApiV1DataSinksDataSinkIdGet: <ThrowOnError extends boolean = false>(options: Options<GetDataSinkApiV1DataSinksDataSinkIdGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<DataSink, HTTPValidationError, ThrowOnError>;
/**
 * Update Data Sink
 * Update a data sink by ID.
 */
declare const updateDataSinkApiV1DataSinksDataSinkIdPut: <ThrowOnError extends boolean = false>(options: Options<UpdateDataSinkApiV1DataSinksDataSinkIdPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<DataSink, HTTPValidationError, ThrowOnError>;
/**
 * Delete Data Sink
 ...
 * If project_id is not provided, uses the default project.
 */
declare const listDataSourcesApiV1DataSourcesGet: <ThrowOnError extends boolean = false>(options?: Options<ListDataSourcesApiV1DataSourcesGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListDataSourcesApiV1DataSourcesGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Create Data Source
 * Create a new data source.
 */
declare const createDataSourceApiV1DataSourcesPost: <ThrowOnError extends boolean = false>(options: Options<CreateDataSourceApiV1DataSourcesPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<DataSource, HTTPValidationError, ThrowOnError>;
/**
 * Upsert Data Source
 ...
 */
declare const upsertDataSourceApiV1DataSourcesPut: <ThrowOnError extends boolean = false>(options: Options<UpsertDataSourceApiV1DataSourcesPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<DataSource, HTTPValidationError, ThrowOnError>;
/**
 * Get Data Source
 * Get a data source by ID.
 */
declare const getDataSourceApiV1DataSourcesDataSourceIdGet: <ThrowOnError extends boolean = false>(options: Options<GetDataSourceApiV1DataSourcesDataSourceIdGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<DataSource, HTTPValidationError, ThrowOnError>;
/**
 * Update Data Source
 * Update a data source by ID.
 */
declare const updateDataSourceApiV1DataSourcesDataSourceIdPut: <ThrowOnError extends boolean = false>(options: Options<UpdateDataSourceApiV1DataSourcesDataSourceIdPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<DataSource, HTTPValidationError, ThrowOnError>;
/**
 * Delete Data Source
 ...
 */
declare const listOrganizationsApiV1OrganizationsGet: <ThrowOnError extends boolean = false>(options?: Options<ListOrganizationsApiV1OrganizationsGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListOrganizationsApiV1OrganizationsGetResponse, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const listOrganizationUsersApiV1OrganizationsOrganizationIdUsersGet: <ThrowOnError extends boolean = false>(options: Options<ListOrganizationUsersApiV1OrganizationsOrganizationIdUsersGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListOrganizationUsersApiV1OrganizationsOrganizationIdUsersGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Add Users To Organization
 * Add a user to an organization.
 */
declare const addUsersToOrganizationApiV1OrganizationsOrganizationIdUsersPut: <ThrowOnError extends boolean = false>(options: Options<AddUsersToOrganizationApiV1OrganizationsOrganizationIdUsersPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<AddUsersToOrganizationApiV1OrganizationsOrganizationIdUsersPutResponse, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const listRolesApiV1OrganizationsOrganizationIdRolesGet: <ThrowOnError extends boolean = false>(options: Options<ListRolesApiV1OrganizationsOrganizationIdRolesGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListRolesApiV1OrganizationsOrganizationIdRolesGetResponse, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const getUserRoleApiV1OrganizationsOrganizationIdUsersRolesGet: <ThrowOnError extends boolean = false>(options: Options<GetUserRoleApiV1OrganizationsOrganizationIdUsersRolesGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<UserOrganizationRole, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const listProjectsApiV1ProjectsGet: <ThrowOnError extends boolean = false>(options?: Options<ListProjectsApiV1ProjectsGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListProjectsApiV1ProjectsGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Create Project
 ...
 */
declare const createEvalDatasetForProjectApiV1ProjectsProjectIdEvalDatasetPost: <ThrowOnError extends boolean = false>(options: Options<CreateEvalDatasetForProjectApiV1ProjectsProjectIdEvalDatasetPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<EvalDataset, HTTPValidationError, ThrowOnError>;
/**
 * List Datasets For Project
 * List eval datasets for a project.
 */
declare const listDatasetsForProjectApiV1ProjectsProjectIdEvalDatasetGet: <ThrowOnError extends boolean = false>(options: Options<ListDatasetsForProjectApiV1ProjectsProjectIdEvalDatasetGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListDatasetsForProjectApiV1ProjectsProjectIdEvalDatasetGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Create Local Eval Set For Project
 * Create a new local eval set.
 */
declare const createLocalEvalSetForProjectApiV1ProjectsProjectIdLocalevalsetPost: <ThrowOnError extends boolean = false>(options: Options<CreateLocalEvalSetForProjectApiV1ProjectsProjectIdLocalevalsetPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<CreateLocalEvalSetForProjectApiV1ProjectsProjectIdLocalevalsetPostResponse, HTTPValidationError, ThrowOnError>;
/**
 * List Local Evals For Project
 * List local eval results for a project.
 */
declare const listLocalEvalsForProjectApiV1ProjectsProjectIdLocalevalGet: <ThrowOnError extends boolean = false>(options: Options<ListLocalEvalsForProjectApiV1ProjectsProjectIdLocalevalGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListLocalEvalsForProjectApiV1ProjectsProjectIdLocalevalGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * List Local Eval Sets For Project
 * List local eval sets for a project.
 */
declare const listLocalEvalSetsForProjectApiV1ProjectsProjectIdLocalevalsetsGet: <ThrowOnError extends boolean = false>(options: Options<ListLocalEvalSetsForProjectApiV1ProjectsProjectIdLocalevalsetsGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListLocalEvalSetsForProjectApiV1ProjectsProjectIdLocalevalsetsGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Delete Local Eval Set
 * Delete a local eval set.
 */
declare const deleteLocalEvalSetApiV1ProjectsProjectIdLocalevalsetLocalEvalSetIdDelete: <ThrowOnError extends boolean = false>(options: Options<DeleteLocalEvalSetApiV1ProjectsProjectIdLocalevalsetLocalEvalSetIdDeleteData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<unknown, HTTPValidationError, ThrowOnError>;
/**
 * Create Prompt Mixin Prompts
 * Create a new PromptMixin prompt set.
 */
declare const createPromptMixinPromptsApiV1ProjectsProjectIdPromptsPost: <ThrowOnError extends boolean = false>(options: Options<CreatePromptMixinPromptsApiV1ProjectsProjectIdPromptsPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<PromptMixinPrompts, HTTPValidationError, ThrowOnError>;
/**
 * List Promptmixin Prompts
 * List PromptMixin prompt sets for a project.
 */
declare const listPromptmixinPromptsApiV1ProjectsProjectIdPromptsGet: <ThrowOnError extends boolean = false>(options: Options<ListPromptmixinPromptsApiV1ProjectsProjectIdPromptsGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListPromptmixinPromptsApiV1ProjectsProjectIdPromptsGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Update Promptmixin Prompts
 * Update a PromptMixin prompt set.
 */
declare const updatePromptmixinPromptsApiV1ProjectsProjectIdPromptsPromptSetIdPut: <ThrowOnError extends boolean = false>(options: Options<UpdatePromptmixinPromptsApiV1ProjectsProjectIdPromptsPromptSetIdPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<PromptMixinPrompts, HTTPValidationError, ThrowOnError>;
/**
 * Delete Prompt Mixin Prompts
 * Delete a PromptMixin prompt set.
 */
declare const deletePromptMixinPromptsApiV1ProjectsProjectIdPromptsPromptSetIdDelete: <ThrowOnError extends boolean = false>(options: Options<DeletePromptMixinPromptsApiV1ProjectsProjectIdPromptsPromptSetIdDeleteData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<unknown, HTTPValidationError, ThrowOnError>;
/**
 * Get File
 ...
 * Read File metadata objects.
 */
declare const listFilesApiV1FilesGet: <ThrowOnError extends boolean = false>(options?: Options<ListFilesApiV1FilesGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListFilesApiV1FilesGetResponse, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const syncFilesApiV1FilesSyncPut: <ThrowOnError extends boolean = false>(options?: Options<SyncFilesApiV1FilesSyncPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<SyncFilesApiV1FilesSyncPutResponse, HTTPValidationError, ThrowOnError>;
/**
 * Read File Content
 ...
 */
declare const listFilePageScreenshotsApiV1FilesIdPageScreenshotsGet: <ThrowOnError extends boolean = false>(options: Options<ListFilePageScreenshotsApiV1FilesIdPageScreenshotsGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListFilePageScreenshotsApiV1FilesIdPageScreenshotsGetResponse, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const searchPipelinesApiV1PipelinesGet: <ThrowOnError extends boolean = false>(options?: Options<SearchPipelinesApiV1PipelinesGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<SearchPipelinesApiV1PipelinesGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Create Pipeline
 * Create a new pipeline for a project.
 */
declare const createPipelineApiV1PipelinesPost: <ThrowOnError extends boolean = false>(options: Options<CreatePipelineApiV1PipelinesPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<Pipeline, HTTPValidationError, ThrowOnError>;
/**
 * Upsert Pipeline
 ...
 */
declare const upsertPipelineApiV1PipelinesPut: <ThrowOnError extends boolean = false>(options: Options<UpsertPipelineApiV1PipelinesPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<Pipeline, HTTPValidationError, ThrowOnError>;
/**
 * Get Pipeline
 * Get a pipeline by ID for a given project.
 */
declare const getPipelineApiV1PipelinesPipelineIdGet: <ThrowOnError extends boolean = false>(options: Options<GetPipelineApiV1PipelinesPipelineIdGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<Pipeline, HTTPValidationError, ThrowOnError>;
/**
 * Update Existing Pipeline
 * Update an existing pipeline for a project.
 */
declare const updateExistingPipelineApiV1PipelinesPipelineIdPut: <ThrowOnError extends boolean = false>(options: Options<UpdateExistingPipelineApiV1PipelinesPipelineIdPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<Pipeline, HTTPValidationError, ThrowOnError>;
/**
 * Delete Pipeline
 ...
 */
declare const syncPipelineApiV1PipelinesPipelineIdSyncPost: <ThrowOnError extends boolean = false>(options: Options<SyncPipelineApiV1PipelinesPipelineIdSyncPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<Pipeline, HTTPValidationError, ThrowOnError>;
/**
 * Copy Pipeline
 * Copy a pipeline by ID.
 */
declare const copyPipelineApiV1PipelinesPipelineIdCopyPost: <ThrowOnError extends boolean = false>(options: Options<CopyPipelineApiV1PipelinesPipelineIdCopyPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<Pipeline, HTTPValidationError, ThrowOnError>;
/**
 * Execute Eval Dataset
 * Execute a dataset.
 */
declare const executeEvalDatasetApiV1PipelinesPipelineIdEvalDatasetsEvalDatasetIdExecutePost: <ThrowOnError extends boolean = false>(options: Options<ExecuteEvalDatasetApiV1PipelinesPipelineIdEvalDatasetsEvalDatasetIdExecutePostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<EvalDatasetJobRecord, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const getEvalDatasetExecutionResultApiV1PipelinesPipelineIdEvalDatasetsEvalDatasetIdExecuteResultGet: <ThrowOnError extends boolean = false>(options: Options<GetEvalDatasetExecutionResultApiV1PipelinesPipelineIdEvalDatasetsEvalDatasetIdExecuteResultGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<GetEvalDatasetExecutionResultApiV1PipelinesPipelineIdEvalDatasetsEvalDatasetIdExecuteResultGetResponse, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const listPipelineFilesApiV1PipelinesPipelineIdFilesGet: <ThrowOnError extends boolean = false>(options: Options<ListPipelineFilesApiV1PipelinesPipelineIdFilesGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListPipelineFilesApiV1PipelinesPipelineIdFilesGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Add Files To Pipeline
 * Add files to a pipeline.
 */
declare const addFilesToPipelineApiV1PipelinesPipelineIdFilesPut: <ThrowOnError extends boolean = false>(options: Options<AddFilesToPipelineApiV1PipelinesPipelineIdFilesPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<AddFilesToPipelineApiV1PipelinesPipelineIdFilesPutResponse, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const importPipelineMetadataApiV1PipelinesPipelineIdMetadataPut: <ThrowOnError extends boolean = false>(options: Options<ImportPipelineMetadataApiV1PipelinesPipelineIdMetadataPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ImportPipelineMetadataApiV1PipelinesPipelineIdMetadataPutResponse, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const listPipelineJobsApiV1PipelinesPipelineIdJobsGet: <ThrowOnError extends boolean = false>(options: Options<ListPipelineJobsApiV1PipelinesPipelineIdJobsGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListPipelineJobsApiV1PipelinesPipelineIdJobsGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Get Pipeline Job
 ...
 */
declare const createBatchPipelineDocumentsApiV1PipelinesPipelineIdDocumentsPost: <ThrowOnError extends boolean = false>(options: Options<CreateBatchPipelineDocumentsApiV1PipelinesPipelineIdDocumentsPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<CreateBatchPipelineDocumentsApiV1PipelinesPipelineIdDocumentsPostResponse, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const upsertBatchPipelineDocumentsApiV1PipelinesPipelineIdDocumentsPut: <ThrowOnError extends boolean = false>(options: Options<UpsertBatchPipelineDocumentsApiV1PipelinesPipelineIdDocumentsPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<UpsertBatchPipelineDocumentsApiV1PipelinesPipelineIdDocumentsPutResponse, HTTPValidationError, ThrowOnError>;
/**
 ...
 * Get a dataset by ID.
 */
declare const getDatasetApiV1EvalsDatasetsDatasetIdGet: <ThrowOnError extends boolean = false>(options: Options<GetDatasetApiV1EvalsDatasetsDatasetIdGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<EvalDataset, HTTPValidationError, ThrowOnError>;
/**
 * Update Dataset
 * Update a dataset.
 */
declare const updateDatasetApiV1EvalsDatasetsDatasetIdPut: <ThrowOnError extends boolean = false>(options: Options<UpdateDatasetApiV1EvalsDatasetsDatasetIdPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<EvalDataset, HTTPValidationError, ThrowOnError>;
/**
 * Delete Dataset
 * Delete a dataset.
 */
declare const deleteDatasetApiV1EvalsDatasetsDatasetIdDelete: <ThrowOnError extends boolean = false>(options: Options<DeleteDatasetApiV1EvalsDatasetsDatasetIdDeleteData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<void, HTTPValidationError, ThrowOnError>;
/**
 * Create Question
 * Create a new question.
 */
declare const createQuestionApiV1EvalsDatasetsDatasetIdQuestionPost: <ThrowOnError extends boolean = false>(options: Options<CreateQuestionApiV1EvalsDatasetsDatasetIdQuestionPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<EvalQuestion, HTTPValidationError, ThrowOnError>;
/**
 * List Questions
 * List questions for a dataset.
 */
declare const listQuestionsApiV1EvalsDatasetsDatasetIdQuestionGet: <ThrowOnError extends boolean = false>(options: Options<ListQuestionsApiV1EvalsDatasetsDatasetIdQuestionGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListQuestionsApiV1EvalsDatasetsDatasetIdQuestionGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Create Questions
 * Create a new question.
 */
declare const createQuestionsApiV1EvalsDatasetsDatasetIdQuestionsPost: <ThrowOnError extends boolean = false>(options: Options<CreateQuestionsApiV1EvalsDatasetsDatasetIdQuestionsPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<CreateQuestionsApiV1EvalsDatasetsDatasetIdQuestionsPostResponse, HTTPValidationError, ThrowOnError>;
/**
 * Get Question
 * Get a question by ID.
 */
declare const getQuestionApiV1EvalsQuestionsQuestionIdGet: <ThrowOnError extends boolean = false>(options: Options<GetQuestionApiV1EvalsQuestionsQuestionIdGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<EvalQuestion, HTTPValidationError, ThrowOnError>;
/**
 * Replace Question
 * Replace a question.
 */
declare const replaceQuestionApiV1EvalsQuestionsQuestionIdPut: <ThrowOnError extends boolean = false>(options: Options<ReplaceQuestionApiV1EvalsQuestionsQuestionIdPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<EvalQuestion, HTTPValidationError, ThrowOnError>;
/**
 * Delete Question
 * Delete a question.
 */
declare const deleteQuestionApiV1EvalsQuestionsQuestionIdDelete: <ThrowOnError extends boolean = false>(options: Options<DeleteQuestionApiV1EvalsQuestionsQuestionIdDeleteData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<void, HTTPValidationError, ThrowOnError>;
/**
 * List Supported Models
 * List supported models.
 */
declare const listSupportedModelsApiV1EvalsModelsGet: <ThrowOnError extends boolean = false>(options?: Options<ListSupportedModelsApiV1EvalsModelsGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListSupportedModelsApiV1EvalsModelsGetResponse, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const getSupportedFileExtensionsApiV1ParsingSupportedFileExtensionsGet: <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => _hey_api_client_fetch.RequestResult<GetSupportedFileExtensionsApiV1ParsingSupportedFileExtensionsGetResponse, unknown, ThrowOnError>;
/**
 * Upload File
 ...
 */
declare const usageApiV1ParsingUsageGet: <ThrowOnError extends boolean = false>(options?: Options<UsageApiV1ParsingUsageGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ParsingUsage, HTTPValidationError, ThrowOnError>;
/**
 * Get Job
 * Get a job by id
 */
 ...
 */
declare const getParsingHistoryResultApiV1ParsingHistoryGet: <ThrowOnError extends boolean = false>(options?: Options<GetParsingHistoryResultApiV1ParsingHistoryGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<GetParsingHistoryResultApiV1ParsingHistoryGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Generate Presigned Url
 ...
 */
declare const listTransformationDefinitionsApiV1ComponentDefinitionConfigurableTransformationsGet: <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListTransformationDefinitionsApiV1ComponentDefinitionConfigurableTransformationsGetResponse, unknown, ThrowOnError>;
/**
 * List Data Source Definitions
 * List data source component definitions.
 */
declare const listDataSourceDefinitionsApiV1ComponentDefinitionDataSourcesGet: <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListDataSourceDefinitionsApiV1ComponentDefinitionDataSourcesGetResponse, unknown, ThrowOnError>;
/**
 * List Data Sink Definitions
 * List data sink component definitions.
 */
declare const listDataSinkDefinitionsApiV1ComponentDefinitionDataSinksGet: <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListDataSinkDefinitionsApiV1ComponentDefinitionDataSinksGetResponse, unknown, ThrowOnError>;
/**
 ...
 */
declare const stripeWebhookApiV1BillingWebhookPost: <ThrowOnError extends boolean = false>(options?: Options<StripeWebhookApiV1BillingWebhookPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<unknown, HTTPValidationError, ThrowOnError>;
/**
 * Create Schema
 */
declare const createSchemaApiV1ExtractionSchemasPost: <ThrowOnError extends boolean = false>(options: Options<CreateSchemaApiV1ExtractionSchemasPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionSchema, HTTPValidationError, ThrowOnError>;
/**
 * List Schemas
 */
declare const listSchemasApiV1ExtractionSchemasGet: <ThrowOnError extends boolean = false>(options?: Options<ListSchemasApiV1ExtractionSchemasGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListSchemasApiV1ExtractionSchemasGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Infer Schema
 */
declare const inferSchemaApiV1ExtractionSchemasInferPost: <ThrowOnError extends boolean = false>(options: Options<InferSchemaApiV1ExtractionSchemasInferPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionSchema, HTTPValidationError, ThrowOnError>;
/**
 * Get Schema
 */
declare const getSchemaApiV1ExtractionSchemasSchemaIdGet: <ThrowOnError extends boolean = false>(options: Options<GetSchemaApiV1ExtractionSchemasSchemaIdGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionSchema, HTTPValidationError, ThrowOnError>;
/**
 * Update Schema
 */
declare const updateSchemaApiV1ExtractionSchemasSchemaIdPut: <ThrowOnError extends boolean = false>(options: Options<UpdateSchemaApiV1ExtractionSchemasSchemaIdPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionSchema, HTTPValidationError, ThrowOnError>;
/**
 * List Jobs
 */
declare const listJobsApiV1ExtractionJobsGet: <ThrowOnError extends boolean = false>(options: Options<ListJobsApiV1ExtractionJobsGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListJobsApiV1ExtractionJobsGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Run Job
 */
declare const runJobApiV1ExtractionJobsPost: <ThrowOnError extends boolean = false>(options: Options<RunJobApiV1ExtractionJobsPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionJob, HTTPValidationError, ThrowOnError>;
/**
 * Get Job
 */
declare const getJobApiV1ExtractionJobsJobIdGet: <ThrowOnError extends boolean = false>(options: Options<GetJobApiV1ExtractionJobsJobIdGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionJob, HTTPValidationError, ThrowOnError>;
/**
 * Run Jobs In Batch
 */
declare const runJobsInBatchApiV1ExtractionJobsBatchPost: <ThrowOnError extends boolean = false>(options: Options<RunJobsInBatchApiV1ExtractionJobsBatchPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<RunJobsInBatchApiV1ExtractionJobsBatchPostResponse, HTTPValidationError, ThrowOnError>;
/**
 * Get Job Result
 */
declare const getJobResultApiV1ExtractionJobsJobIdResultGet: <ThrowOnError extends boolean = false>(options: Options<GetJobResultApiV1ExtractionJobsJobIdResultGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionResult, HTTPValidationError, ThrowOnError>;
/**
 * Get Job Image Result
 * Get a job by id
 */
 ...
 * Get a list of supported file extensions
 */
declare const getSupportedFileExtensionsApiParsingSupportedFileExtensionsGet: <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => _hey_api_client_fetch.RequestResult<GetSupportedFileExtensionsApiParsingSupportedFileExtensionsGetResponse, unknown, ThrowOnError>;
/**
 * Upload File
 * Upload a file to s3 and create a job. return a job id
 */
 ...
 * Get parsing usage for user
 */
declare const usageApiParsingUsageGet: <ThrowOnError extends boolean = false>(options?: Options<UsageApiParsingUsageGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ParsingUsage, HTTPValidationError, ThrowOnError>;
/**
 * Get Job
 * Get a job by id
 */
 ...
 * Get parsing history for user
 */
declare const getParsingHistoryResultApiParsingHistoryGet: <ThrowOnError extends boolean = false>(options?: Options<GetParsingHistoryResultApiParsingHistoryGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<GetParsingHistoryResultApiParsingHistoryGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Generate Presigned Url
 * Generate a presigned URL for a job
 */
