...
var T = /\{[^{}]+\}/g, h = ({ allowReserved: i, name: n, value: e })=>{
    ...
    typeof e == "string" || e instanceof Blob ? i.append(n, e) : i.append(n, JSON.stringify(e));
}, k = {
    bodySerializer: (i)=>{
        let n = new FormData;
        return Object.entries(i).forEach(([e, a])=>{
            a != null && (Array.isArray(a) ? a.forEach((o)=>q(n, e, o)) : q(n, e, a));
        }), n;
    }
}, E = {
...
/**
 * Create Schema
 */ const createSchemaApiV1ExtractionSchemasPost = (options)=>{
    return (options?.client ?? client).post({
        ...options,
...
/**
 * List Schemas
 */ const listSchemasApiV1ExtractionSchemasGet = (options)=>{
    return (options?.client ?? client).get({
        ...options,
        url: "/api/v1/extraction/schemas"
    });
...
/**
 * Infer Schema
 */ const inferSchemaApiV1ExtractionSchemasInferPost = (options)=>{
    return (options?.client ?? client).post({
        ...options,
...
/**
 * Get Schema
 */ const getSchemaApiV1ExtractionSchemasSchemaIdGet = (options)=>{
    return (options?.client ?? client).get({
        ...options,
...
/**
 * Update Schema
 */ const updateSchemaApiV1ExtractionSchemasSchemaIdPut = (options)=>{
    return (options?.client ?? client).put({
        ...options,
        url: "/api/v1/extraction/schemas/{schema_id}"
    });
...
/**
 * Run Jobs In Batch
 */ const runJobsInBatchApiV1ExtractionJobsBatchPost = (options)=>{
    return (options?.client ?? client).post({
        ...options,
