import { emptyLogger, consoleLogger, randomUUID } from '@llamaindex/env';
 ...
 */ class AgentRunner extends BaseChatEngine {
    ...
    constructor(params){
        super(), this.#systemPrompt = null, _initProto(this);
                ...
                if (output instanceof ReadableStream) {
                    return output.pipeThrough(new TransformStream({
                        transform (chunk, controller) {
                            controller.enqueue(EngineResponse.fromChatResponseChunk(chunk, chunk.sourceNodes));
                        }
                    }));
                } else {
